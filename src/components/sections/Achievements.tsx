...
export function Achievements() {
  ...
  return (
    <section id="achievements" className="py-16 md:py-24 bg-transparent relative z-10">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {achievements.map((achievement, index) => (
            <Reveal key={index} delay={index * 0.1}>
              <div className="group h-full p-8 rounded-2xl bg-background/50 border border-border hover:border-[#3B82F6]/50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] relative overflow-hidden backdrop-blur-sm flex flex-col justify-between">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <Typography variant="mono" className="text-xs text-secondary">
                      {achievement.date}
                    </Typography>
                  </div>
                  ...
                  <Typography variant="p" className="text-secondary text-sm mt-0 leading-relaxed">
